...
2.2. **Configuração de Áudio no VLC**
   ...
   ![Configuração de Áudio no VLC](/images/Configuração%20VLC.png)
...
2.3. **Configuração de Áudio no MMSSTV**
   ...
   ![Configuração de Áudio no MMSSTV](/images/Configuracao%20MMSSTV.png)
...
![Imagem SSTV com a flag.](/images/Imagem%20SSTV%20com%20Flag.png)
